...
SRCS=ft_putchar.c ft_putstr.c ft_tolower.c ft_toupper.c ft_isprint.c \
	   ...
	   ft_strlcat.c ft_strncpy.c ft_strdup.c ft_memcmp.c ft_memchr.c \
	   ft_memmove.c ft_memcpy.c ft_memccpy.c ft_memset.c ft_bzero.c \
	   ft_memalloc.c ft_memdel.c ft_strnew.c ft_strdel.c ft_strclr.c \
	   ft_striter.c ft_striteri.c ft_strmap.c ft_strmapi.c ft_strequ.c \
	   ft_strnequ.c ft_strsub.c ft_strjoin.c ft_strtrim.c ft_strsplit.c \
	   ft_putstr_fd.c ft_putchar_fd.c ft_putendl.c ft_putnbr.c ft_putendl_fd.c \
	   ft_putnbr_fd.c ft_itoa.c ft_count_wordlen.c ft_count_words.c ft_lstnew.c \
...
OBJECTS=ft_putchar.o ft_putstr.o ft_tolower.o ft_toupper.o ft_isprint.o \
		  ...
		  ft_strlcat.o ft_strncpy.o ft_strdup.o ft_memcmp.o ft_memchr.o \
		  ft_memmove.o ft_memcpy.o ft_memccpy.o ft_memset.o ft_bzero.o \
		  ...
		  ft_putstr_fd.o ft_putchar_fd.o ft_putendl.o ft_putnbr.o ft_putendl_fd.o \
		  ft_putnbr_fd.o ft_itoa.o ft_count_wordlen.o ft_count_words.o ft_lstnew.o \
